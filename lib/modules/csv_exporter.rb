  ...
  private
    ...
    def self.format_row(result)
      ...
      row = [
        ...
        result.find_answer_by_key_value("short_code", "humans_separate", default),
        result.find_answer_by_key_value("short_code", "provides_benefits", default),
        result.find_answer_by_key_value("short_code", "nature_sake", default),
        result.find_answer_by_key_value("short_code", "ethical_imperative", default),
        result.find_answer_by_key_value("short_code", "impact_rich", default),
        result.find_answer_by_key_value("short_code", "biological_science", default),
        result.find_answer_by_key_value("short_code", "people_displaced", default),
        result.find_answer_by_key_value("short_code", "pristine_nature", default),
        result.find_answer_by_key_value("short_code", "strict_protected_areas", default),
        result.find_answer_by_key_value("short_code", "science_based", default),
        result.find_answer_by_key_value("short_code", "own_sake", default),
        result.find_answer_by_key_value("short_code", "value_landscapes", default),
        result.find_answer_by_key_value("short_code", "public_support", default),
        result.find_answer_by_key_value("short_code", "with_capitalism", default),
        result.find_answer_by_key_value("short_code", "corporations_pragmatic", default),
        result.find_answer_by_key_value("short_code", "population growth", default),
        result.find_answer_by_key_value("short_code", "affection_income", default),
        result.find_answer_by_key_value("short_code", "advancing_wellbeing", default),
        result.find_answer_by_key_value("short_code", "emotional_separation", default),
        result.find_answer_by_key_value("short_code", "ethical_values", default),
        result.find_answer_by_key_value("short_code", "ecosystem_goal", default),
        result.find_answer_by_key_value("short_code", "economic_arguments", default),
        result.find_answer_by_key_value("short_code", "displace_motivations", default),
        result.find_answer_by_key_value("short_code", "giving_voice_improves", default),
        result.find_answer_by_key_value("short_code", "reform_global_trade", default),
        result.find_answer_by_key_value("short_code", "Non_native_species", default),
        result.find_answer_by_key_value("short_code", "impact_incomes", default),
        result.find_answer_by_key_value("short_code", "support_corporations", default),
        result.find_answer_by_key_value("short_code", "seek_no_harm", default),
        result.find_answer_by_key_value("short_code", "giving_voice_ethical", default),
        result.find_answer_by_key_value("short_code", "economic_growth", default),
        result.find_answer_by_key_value("short_code", "communities_manage", default),
        result.find_answer_by_key_value("short_code", "win_win", default),
        result.find_answer_by_key_value("short_code", "rationales_weakens", default),
        result.find_answer_by_key_value("short_code", "emphasise_value", default),
        result.find_answer_by_key_value("short_code", "doom_gloom", default),
        result.find_answer_by_key_value("short_code", "biological_diversity", default),
        result.find_answer_by_key_value("short_code", "severe_perturbations", default),
